 ...
 */
int dtls_setup(int sock);

/** @brief Determine if DTLS Connection ID is available
 *
 ...
 *
 *  @retval true - the modem supports CID
 *  @retval false - the modem does not support CID
 */
